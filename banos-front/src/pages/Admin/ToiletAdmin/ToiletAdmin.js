...
export default function ToiletAdmin() {
    ...
    const handleForm = async () => {
        ...
        let reponse = await fetch('http://localhost:8080/toilets/addToilet', {
            method: 'POST',
            headers: {
    ...
    return (<>
        <NavbarAdmin />
        <Button variant="contained" onClick={handleShow}>Añadir baño</Button>

        <Modal show={show} onHide={handleClose}>
            <Modal.Header closeButton>
                <Modal.Title>Añadir baño</Modal.Title>
            </Modal.Header>
            <Modal.Body>
                <div className="login-page">
                    ...
                    <div>
                        <form>
                            ...
                            <div>
                                <TextField name="Latitud" label="Latitud" variant="outlined" onChange={(e) => setFormData({ ...formData, lat: e.target.value })} />
                            </div>
                            <div>
                                <TextField name="Longitud" label="Longitud" variant="outlined" onChange={(e) => setFormData({ ...formData, lng: e.target.value })} />
                            </div>
                            <div>
